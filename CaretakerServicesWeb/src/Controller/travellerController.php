...
class travellerController extends AbstractController
{
    ...
    #[Route('/admin-panel/traveller/list', name: 'travellerList')]
    public function travellerList()
    {
        ...
        $travellersList = $response->toArray();

        // echo "<pre>";
        // print_r($travellersList);
        // echo "</pre>";

        return $this->render('backend/travellers.html.twig', [
            'travellers' => $travellersList['hydra:member']
        ]);
    }
}
