 ...
 */
final class Version20240523150945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cs_reservation (id INT AUTO_INCREMENT NOT NULL, apartment_id INT DEFAULT NULL, service_id INT DEFAULT NULL, user_id INT DEFAULT NULL, starting_date DATETIME NOT NULL, ending_date DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, active TINYINT(1) NOT NULL, adult_travelers INT DEFAULT NULL, child_travelers INT DEFAULT NULL, baby_travelers INT DEFAULT NULL, INDEX IDX_4199FEBB176DFE85 (apartment_id), INDEX IDX_4199FEBBED5CA9E6 (service_id), INDEX IDX_4199FEBBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cs_service (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_E0838CD3979B1AD6 (company_id), INDEX IDX_E0838CD312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
