 ...
 */
final class Version20240702100607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cs_document (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, attached_reserv_id INT DEFAULT NULL, name VARCHAR(300) NOT NULL, type VARCHAR(50) NOT NULL, url VARCHAR(300) NOT NULL, date_creation DATETIME NOT NULL, visibility TINYINT(1) NOT NULL, INDEX IDX_AF6FA4F67E3C61F9 (owner_id), INDEX IDX_AF6FA4F6A3A2F86D (attached_reserv_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cs_reservation (id INT AUTO_INCREMENT NOT NULL, apartment_id INT DEFAULT NULL, service_id INT DEFAULT NULL, user_id INT DEFAULT NULL, starting_date DATETIME NOT NULL, ending_date DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, payement_id VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, adult_travelers INT NOT NULL, child_travelers INT NOT NULL, baby_travelers INT NOT NULL, unavailability TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, other_data JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', is_request TINYINT(1) NOT NULL, status SMALLINT DEFAULT NULL, INDEX IDX_4199FEBB176DFE85 (apartment_id), INDEX IDX_4199FEBBED5CA9E6 (service_id), INDEX IDX_4199FEBBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cs_reviews (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, apartment_id INT DEFAULT NULL, author_id INT NOT NULL, reservation_id INT NOT NULL, content LONGTEXT NOT NULL, rate SMALLINT NOT NULL, post_date DATETIME NOT NULL, INDEX IDX_686EFD0EED5CA9E6 (service_id), INDEX IDX_686EFD0E176DFE85 (apartment_id), INDEX IDX_686EFD0EF675F31B (author_id), UNIQUE INDEX UNIQ_686EFD0EB83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cs_service (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, cover_image VARCHAR(255) DEFAULT NULL, address_inputs SMALLINT NOT NULL, days_of_week JSON NOT NULL COMMENT \'(DC2Type:json)\', start_time VARCHAR(255) NOT NULL, end_time VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, INDEX IDX_E0838CD3979B1AD6 (company_id), INDEX IDX_E0838CD312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cs_user (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, firstname VARCHAR(150) NOT NULL, lastname VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, last_connection DATETIME NOT NULL, date_inscription DATETIME NOT NULL, profile_pict VARCHAR(500) DEFAULT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', tel_number VARCHAR(10) NOT NULL, is_verified TINYINT(1) NOT NULL, professional TINYINT(1) NOT NULL, subscription INT DEFAULT NULL, is_ban TINYINT(1) NOT NULL, subs_id VARCHAR(255) DEFAULT NULL, subs_date DATETIME DEFAULT NULL, INDEX IDX_BC10A726979B1AD6 (company_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
